...
public class Board {
	...
	public Board() {
	 ...
	 //ODO: initialise the cells array using ROWS and COLS constants 
	...
	// ODO: Check whether the game has ended in a draw. 
		...
		for (int row = 0; row < GameMain.ROWS; ++row) {
            for (int col = 0; col < GameMain.COLS; ++col) {
               if (cells[row][col].content == Player.Empty) {
                  return false; // still have empty cells - Not a draw
               }
            }
		}
		 return true; //Game is a draw - No more empty cells
	}
...
//CHECK FOR WINNERS	
	...
	public boolean hasWon(Player thePlayer, int playerRow, int playerCol) {
		...
		if(cells[playerRow][0].content == thePlayer && cells[playerRow][1].content == thePlayer && cells[playerRow][2].content == thePlayer )
		 ...
		 // ODO: Check if the player has 3 in the playerCol.
		...
		if(cells[0][playerCol].content == thePlayer && cells[1][playerCol].content == thePlayer && cells[2][playerCol].content == thePlayer )
		 ...
		 // 3-in-the-diagonal - TopLeft - BottomRight
		if( cells[0][0].content == thePlayer && cells[1][1].content == thePlayer && cells[2][2].content == thePlayer)
			return true;
		 
		
		// ODO: Check the diagonal in the other direction
		// 3-in-the-other-diagonal - TopRight - BottomLeft

...
public class Cell {
	...
	public Cell(int row, int col) {
		// ODO: Initialise the variables row, col 
		this.row = row; //Sets the current row
		this.col = col; //Sets the current col
	//	content = Player.Empty;
		
		//ODO: call the method that sets the cell content to EMPTY
		 clear();
	}
